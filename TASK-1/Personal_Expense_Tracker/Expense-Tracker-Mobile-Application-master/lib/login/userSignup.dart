      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Text('Please fill the details to create an account',style: TextStyle(
                color: Colors.grey,
                fontFamily: 'Poppins',
                fontSize: 10.0,
                fontWeight: FontWeight.bold,
                    ...
                    if(!validateName && !validatePsw && !validateCPsw){
                      ...
                      if(valName && valPsw){
                        ...
                        if(valName && !valPsw){
                          ...
                          Toast.show(
                            'Validation Errors on both UserName & Password',
                            textStyle: const TextStyle(
                              color: Colors.black,
                              fontFamily: 'Poppins',
                              fontSize: 13.0,
        ...
        builder: (param){
          return AlertDialog(
            ...
            content: Container(
              ...
              child: const Column(
                children: [
                  Text('UserName must start with an alphabet of Lower Case',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'Poppins',
                  ),),
                  SizedBox(
                  ...
                  Text('UserName length must be of minimum 7',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'Poppins',
                  ),),
                  SizedBox(
                  ...
                  Text('UserName must contain 2 Numbers and a Special Character',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'Poppins',
                  ),),
                  SizedBox(
                  ...
                  Text('UserName must not have an upper case in it',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'Poppins',
                  ),),
                  SizedBox(
